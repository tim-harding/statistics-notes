...
\begin{center}
    \begin{tabular}{|l|l|l|l|}
        ...
        Name             & Right tailed              & Left tailed                & Two tailed                         \\ \hline
        $\sigma$ known   & $z > z_\alpha$            & $z < -z_\alpha$            & $|z| > z_\alpha$                   \\ \hline
        $\sigma$ unknown & $t > t_{\alpha, n - 1}$   & $t < -t_{\alpha, n - 1}$   & $|t| > t_{\alpha, n - 1}$          \\ \hline
        p-value          & $\tcdf(t, \infty, n - 1)$ & $\tcdf(-\infty, t, n - 1)$ & $2 \times \tcdf(t, \infty, n - 1)$ \\ \hline
    \end{tabular}
\end{center}

$\alpha \equiv desired significance$
$p \equiv attained significance$
Significance means the probability of getting the attained statistic assuming that the null hypothesis is true.
